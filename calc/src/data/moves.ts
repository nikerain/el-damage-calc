...
const EL_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  Barrage: {bp: 20},
  Bind: {bp: 35},
  'Comet Punch': {bp: 25},
  Constrict: {bp: 40},
  ...
  'Doom Desire': {bp: 150},
  'Metal Claw': {bp: 60},
  'Spike Cannon': {bp: 30, type: 'Steel'},
};

const EL: {[name: string]: MoveData} = extend(true, {}, ADV, EL_PATCH);
...
export const MOVES = [{}, RBY, GSC, EL, DPP, BW, XY, SM, SS, SV];
