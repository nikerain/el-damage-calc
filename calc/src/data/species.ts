...
const EL_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  Ekans: {bs: {hp: 40, at: 65, sp: 60}},
  Arbok: {bs: {hp: 62, at: 95, df: 85, sp: 90}},
  Pikachu: {bs: {df: 40, sd: 50}},
  Clefable: {bs: {sa: 95}},
  Vulpix: {bs: {hp: 45, sp: 75, sa: 55, sd: 70}},
  Ninetales: {bs: {hp: 78, at: 71, df: 80, sa: 86}},
  Wigglytuff: {bs: {df: 55, sa: 85, sd: 55}},
  Oddish: {bs: {hp: 50}},
  Gloom: {bs: {hp: 70}},
  Vileplume: {bs: {hp: 90}},
  Venomoth: {bs: {at: 75, sp: 100, sd: 95}},
  Dugtrio: {bs: {at: 90}},
  Ponyta: {bs: {sp: 100}},
  Rapidash: {bs: {sp: 115}},
  Dewgong: {bs: {at: 60, sa: 80}},
  Grimer: {bs: {sd: 75}},
  Shellder: {bs: {hp: 35}},
  Marowak: {bs: {hp: 65}},
  Hitmonlee: {bs: {df: 58}},
  Hitmonchan: {bs: {sp: 81}},
  Lickitung: {bs: {hp: 95, at: 70, df: 85, sa: 75, sd: 85}},
  Weezing: {bs: {hp: 75}},
  Seaking: {bs: {at: 100}},
  Magmar: {bs: {hp: 75}},
  Flareon: {bs: {sa: 110, sd: 95}},
  Porygon: {bs: {hp: 75, at: 70}},
  Furret: {bs: {sa: 55}},
  Ledian: {bs: {hp: 75}},
  Ariados: {bs: {sp: 80, sa: 70, sd: 70}},
  Togetic: {bs: {hp: 85, at: 50}},
  Bellossom: {bs: {hp: 90, df: 95, sd: 110}},
  Marill: {bs: {sa: 40}},
  Azumarill: {bs: {sa: 70}},
  Sudowoodo: {bs: {hp: 80, sd: 85}},
  Aipom: {bs: {hp: 70, at: 90, df: 65, sp: 90, sd: 65}},
  Sunflora: {bs: {sa: 125}},
  Yanma: {bs: {hp: 75, at: 105, df: 65, sa: 65}},
  Quagsire: {bs: {sa: 75, sd: 75}},
  Murkrow: {bs: {hp: 70, at: 105, df: 52, sp: 95, sa: 76, sd: 52}},
  Misdreavus: {bs: {sp: 90, sa: 95, sd: 95}},
  Gligar: {bs: {hp: 70, at: 85, sp: 90}},
  Qwilfish: {bs: {hp: 75, df: 85, sa: 65, sd: 75}},
  Sneasel: {bs: {sa: 70}},
  Slugma: {bs: {hp: 50, at: 70, df: 60, sd: 60}},
  Magcargo: {bs: {hp: 60, at: 80, df: 130, sa: 90, sd: 90}},
  Swinub: {bs: {hp: 80, at: 65, sa: 65, sd: 40}},
  Piloswine: {bs: {sa: 80, sd: 70}},
  Corsola: {bs: {hp: 85, df: 95, sd: 95}},
  Delibird: {bs: {hp: 60, at: 75, df: 55, sp: 80, sa: 85}},
  Mantine: {bs: {at: 50}},
  Hitmontop: {bs: {sp: 75}},
  Entei: {bs: {at: 90, sa: 115}},
  Sceptile: {bs: {sa: 110}},
  Blaziken: {bs: {sp: 85}},
  Mightyena: {bs: {hp: 75, at: 95, df: 75, sp: 80}},
  Linoone: {bs: {at: 80}},
  Beautifly: {bs: {at: 80, sp: 75, sa: 100}},
  Dustox: {bs: {hp: 70, df: 80, sd: 100}},
  Ludicolo: {bs: {hp: 90, sa: 100}},
  Shiftry: {bs: {at: 110, sp: 85, sa: 95}},
  Shedinja: {bs: {sa: 75}},
  Pelipper: {bs: {hp: 70, sa: 95}},
  Masquerain: {bs: {sp: 80, sa: 100}},
  Wailord: {bs: {df: 50, sa: 100, sd: 50}},
  Delcatty: {bs: {hp: 75, at: 70, df: 70, sp: 95, sa: 75, sd: 65}},
  Kecleon: {bs: {hp: 75, sa: 70}},
  Nosepass: {bs: {hp: 45, sa: 70, sd: 105}},
  Torkoal: {bs: {sa: 95}},
  Sableye: {bs: {hp: 70, df: 95, sp: 40, sd: 95}},
  Luvdisc: {bs: {hp: 58, df: 75, sp: 102, sa: 70, sd: 75}},
  Crawdaunt: {bs: {sa: 100}},
  Sharpedo: {bs: {hp: 80, sp: 105}},
  Vibrava: {bs: {hp: 60, at: 80, df: 60, sp: 80, sa: 60, sd: 60}},
  Flygon: {bs: {sa: 90}},
  ...
  Spoink: {bs: {df: 40, sp: 65}},
  Grumpig: {bs: {hp: 90, at: 35, df: 70, sp: 85}},
  Plusle: {bs: {at: 70, sp: 105, sa: 95, sd: 65}},
  Minun: {bs: {hp: 70, df: 80, sp: 85, sa: 65, sd: 95}},
  Mawile: {bs: {hp: 70, at: 105, df: 105}},
  Meditite: {bs: {sa: 60}},
  Medicham: {bs: {sa: 90}},
  Dusclops: {bs: {hp: 65, at: 60, sa: 75}},
  Roselia: {bs: {hp: 55, at: 65, df: 50, sp: 75, sa: 115, sd: 95}},
  Gulpin: {bs: {hp: 85}},
  Swalot: {bs: {hp: 115}},
  Tropius: {
  ...
  Absol: {bs: {sp: 95}},
  Banette: {bs: {at: 103, sp: 75, sa: 115}},
  Relicanth: {bs: {at: 110}},
  Castform: {bs: {hp: 75, df: 75, sp: 90, sa: 85, sd: 75}},
  Volbeat: {bs: {hp: 70, at: 88, sa: 87, sd: 65}},
  Illumise: {bs: {hp: 80, at: 73, df: 75, sa: 47, sd: 90}},
  Kirlia: {bs: {sa: 75, sd: 65}},
